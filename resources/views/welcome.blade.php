...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('asset/img/logo_bouta.jpeg')}}" rel="icon">
  <link href="{{asset('asset/img/logo_bouta.jpeg')}}" rel="apple-touch-icon">
...
<body class="index-page">
  ...
  <div class="container-fluid container-xl position-relative d-flex align-items-center">
    ...
    <a href="/" class="logo d-flex align-items-center me-auto">
      <img src="{{ asset('asset/img/logo_bouta.jpeg') }}" alt="">
      <h1 class="sitename">CENTRE BOUTA</h1>
    </a>
    ...
    <!-- Dropdown -->
    <div class="dropdown">
      <button class="btn-getstarted flex-md-shrink-0 dropdown-toggle" type="button" id="userMenu" data-bs-toggle="dropdown" aria-expanded="false">
        Connexion
      </button>
      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
        <li><a class="dropdown-item" href="{{ route('login') }}">Administrateur</a></li>
        <li><a class="dropdown-item" href="{{ route('maitre.login') }}">Maitre</a></li>
        <li><a class="dropdown-item" href="{{ route('tuteur.login') }}">Tuteur</a></li>
      </ul>
    </div>
