...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Modification d'une classe</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Modifier une classe</h5>
                    ...
                    <form action="{{route('classe.update', $classe->id )}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <select name="niveau" class="form-select" required>
                                ...
                                <option value="Second cycle" {{ $classe->niveau == 'Second cycle' ? 'selected' : '' }}>Second cycle</option>
                            </select>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="basic-default-name" value="{{$classe->frais}}" name="frais" placeholder="" />
                            </div>
                        </div>
