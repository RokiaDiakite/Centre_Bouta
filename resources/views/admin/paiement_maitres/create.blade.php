...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4>Ajouter un paiement de maître</h4>
    ...
    <div class="card p-4">
        ...
        <form action="{{ route('paiement-maitre.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="maitre_id" id="maitre_id" class="form-select" required onchange="updateMontant()">
                        ...
                        <option value="{{ $m->id }}" data-salaire="{{ $m->salaire }}">{{ $m->nom }} {{ $m->prenom }}</option>
                        @endforeach
                    </select>
                </div>

                <div class="col-md-4">
                    <label for="montant" class="form-label">Montant (automatique)</label>
