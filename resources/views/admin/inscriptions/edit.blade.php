    ...
    <form id="inscriptionForm" action="{{ route('inscription.update', $inscription->id) }}" method="POST">
        ...
        <div class="step step-1">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="eleve_lieu_naissance" class="form-control" value="{{ $inscription->eleve->lieu_naissance }}" required>
                </div>
                <div class="col-md-12 mb-3">
                    <label>Adresse</label>
                    <input type="text" name="eleve_adresse" class="form-control" value="{{ $inscription->eleve->adresse }}" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <label>Sexe</label>
                    <select name="eleve_sexe" class="form-control" value="{{ $inscription->eleve->sexe }}" required>
                ...
                <div class="col-md-6 mb-3">
                    <label>Statut</label>
                    <select name="eleve_statut" class="form-control" value="{{ $inscription->eleve->statut }}" required>
                        <option value="">-- Sélectionnez --</option>
        ...
        <div class="step step-2" style="display:none;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label>Adresse</label>
                    <input type="text" name="tuteur_adresse" class="form-control" value="{{ $inscription->eleve->tuteur->adresse }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label>Numéro</label>
                    <input type="text" name="tuteur_numero" class="form-control" value="{{ $inscription->eleve->tuteur->numero }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label>Nom utilisateur</label>
                    <input type="text" name="tuteur_username" class="form-control" value="{{ $inscription->eleve->tuteur->username }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label>Profession</label>
                    <input type="text" name="tuteur_profession" class="form-control" value="{{ $inscription->eleve->tuteur->profession }}" required>
                </div>
            </div>
        ...
        <div class="step step-3" style="display:none;">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="decimal" name="frais_ins" class="form-control" value="{{ $inscription->frais_ins }}">
                </div>
                <div class="col-md-6 mb-3">
                    <label>Classe</label>
                    <select name="classe_id" class="form-control" required>
                        @foreach ($classes as $classe)
                        <option value="{{ $classe->id }}" {{ $inscription->classe_id == $classe->id ? 'selected' : '' }}>
                            {{ $classe->nom }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="annee_scolaire_id" class="form-control" required>
                        ...
                        <option value="{{ $annee->id }}" {{ $inscription->annee_scolaire_id == $annee->id ? 'selected' : '' }}>
                            {{ $annee->libelle }}
                        </option>
                        @endforeach
                    </select>
...
<script>
    $(document).ready(function() {
        ...
        function updateProgressBar() {
            ...
            $('#progressBar').text('Étape ' + currentStep + ' / ' + totalSteps);
        }
